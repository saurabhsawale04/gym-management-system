            ...
            <div class="container-fluid">
                <div class="navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="ownAddPlan.php">
            ...
            <div class="row gy-5">
                ...
                <div class="col-sm-10 col-md-5 col-lg-5 mx-auto bg-success bg-opacity-10 shadow">
                    ...
                    <div class="d-flex justify-content-around">
                        <a href="ownEditPlan.php?id=<?php echo $res['id']; ?>" class="edit1 card-link text-center col-2" data-bs-toggle="tooltip"
                            data-bs-placement="top" title="Edit info"><i class="fa fas fa-edit"
                                style="font-size: 2rem;"></i></a>
                        <a href="ownPlansDel.php?id=<?php echo $res['id']; ?>" class="edit2 card-link text-center col-2" data-bs-toggle="tooltip"
