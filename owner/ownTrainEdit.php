<?php
    ...
    if(isset($_POST['editTrain']))
    {
        ...
        $updatequery = " UPDATE `$tablename` SET `id`=$id, `name`='$name',`mobile`='$mobile',`address`='$address',`type`='$type',`status`='$status',`date`='$newDate' WHERE `id`=$id;"; 
            ...
            <form action="" method="post" class="row  needs-validation"
                ...
                <div class="col-md-7 mx-auto py-2">
                    ...
                    <div class="input-group has-validation">
                        <input autocomplete="off" type="text" name="name" value="<?php echo $arrdata['name']; ?>" class="form-control" placeholder="Trainer Name"
                ...
                <div class="col-md-7 mx-auto py-2">
                    ...
                    <div class="input-group has-validation">
                        <textarea name="address" value="<?php echo $arrdata['address']; ?>" class="form-control" id="validationCustomUsername"
                ...
                <div class="col-md-7 mx-auto py-2">
                    ...
                    <div class="input-group has-validation">
                        <input autocomplete="off" type="text" name="type" value="<?php echo $arrdata['type']; ?>" class="form-control" placeholder="Trainer Type"
                            id="validationCustomUsername" aria-describedby="inputGroupPrepend" required>
                        <div class="invalid-feedback">
                ...
                <div class="col-md-7 mx-auto py-2">
                    ...
                    <div class="input-group has-validation">
                        <input type="date" name="date" value="<?php echo $arrdata['date']; ?>" class="form-control" id="validationCustomUsername"
                ...
                <div class="col-12 mx-auto mt-3">
                    <p class="h5 my-1 text-center mx-auto">
                        <button type="submit" name="editTrain" class="btn btn-success">Update Trainer</button>
