<?php
    ...
    if(isset($_POST['addMem']))
    {
        ...
        $insertquery = " INSERT INTO `$tablename` (`name`, `mobile`, `address`, `status`, `startdate`, `enddate`) VALUES ('$name', '$mobile', '$address', '$status', '$newStartDate', '$newEndDate'); ";
            ...
            <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="post" class="row  needs-validation"
                ...
                <div class="col-12 mx-auto mt-3">
                    <p class="h5 my-1 text-center mx-auto">
                        <button type="submit" name="addMem" class="btn btn-success">Add Member</button>
